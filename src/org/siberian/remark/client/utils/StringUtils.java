package org.siberian.remark.client.utils;
...
public class StringUtils
{
     ...
     * stripped as defined by {@link Character#isSpace(char)}.
     ...
     *
     * <p>If the stripChars String is {@code null}, whitespace is
     * stripped as defined by {@link Character#isSpace(char)}.</p>
     *
     * <pre>
    ...
    public static String stripStart(String str, String stripChars) {
        ...
        int start = 0;
        if (stripChars == null) {
            while (start != strLen && Character.isSpace(str.charAt(start))) {
                start++;
            }
    ...
    public static boolean containsWhitespace(CharSequence seq) {
        ...
        for (int i = 0; i < strLen; i++) {
            if (Character.isSpace(seq.charAt(i))) {
                return true;
            }
        }
        return false;
     ...
     * @since 2.0
     * @since 3.0 Changed signature from isSpace(String) to isSpace(CharSequence)
     */
    public static boolean isSpace(CharSequence cs) {
        if (cs == null) {
            return false;
        }
        int sz = cs.length();
